...
namespace PrinterErrors
{
    public class Program
    {
        ...
        {
            Kata kata = new Kata();
            Console.WriteLine(kata.PrinterError("aasdaawejhkklsk"));
        }
         ...
         * in a control string. For example a "good" control string would be aaabbbbhaijjjm meaning that the printer used
         * three times color a, four times color b, one time color h then one time color a...
            ...
            aaaxbbbbyyhwawiwjjjwwm with letters not from a to m. You have to write a function printer_error which given a string 
