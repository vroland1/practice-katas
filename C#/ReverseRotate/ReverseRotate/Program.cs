...
namespace ReverseRotate
{
    class Program
    {
        ...
        {
            Kata kata = new Kata();
            Console.WriteLine(kata.ReverseRotate("733049910872815764", 5));
    ...
    the cubes of its digits is divisible by 2, reverse that chunk; otherwise rotate it to the left by one position. Put 
